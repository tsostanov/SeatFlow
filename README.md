...
Сейчас проект состоит из трёх работающих сервисов с gRPC-контрактами и health checks. Внешний Gateway предоставляет REST API, SSE-поток, Prometheus-метрики и веб-интерфейс, Booking управляет сценарием бронирования, а Inventory хранит каталог и состояние мест в PostgreSQL.
